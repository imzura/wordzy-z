...
import CourseProgramming from "./features/course_programming/components/CourseProgrammingForm";
...
const AppRoutes = () => {
  return (
    <Routes>
        ...
        <Route path="/programacionCursos/registrarProgramacion" element={<CourseProgramming/>}/>
